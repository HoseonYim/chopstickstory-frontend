...
function Main() {
    return (
        ...
        <head>
            ...
            <meta name="description" content="CHOPSTICKSTORY - Sharing Korean culture through meaningful experiences. Discover our programs including MunDam: Infusing Culture, YeDam: Infusing Art, DeokDam: Infusing Virtue, and CheDam: Infusing Experiences."/>
            <meta name="keywords" content="Korean culture, cultural education, MunDam, YeDam, DeokDam, CheDam, Korean cultural programs"/>
            <meta name="author" content="CHOPSTICKSTORY"/>
            <meta property="og:title" content="CHOPSTICKSTORY - Celebrating Korean Culture"/>
            <meta property="og:description" content="Join us in our journey to connect cultures through meaningful experiences."/>
            <meta property="og:image" content="./images/STAMP-LOGO.webp"/>
            <meta property="og:url" content="https://theolee021.github.io/ChopstickStory/"/>
        ...
        <body>
            <header>
                <div class="header-content">
                    <div class="logo">
                        <a href="index.html">
                            <img src="./assets/STAMP-LOGO.webp" class="logo-img"/>
                            <p>CHOPSTICKSTORY</p>
                        </a>
                    </div>
                ...
                <div class="menu-links">
                    ...
                    <div class="dropdown">
                        <div class="dropdown-header">
                            ...
                            <button class="dropdown-trigger" aria-label="Toggle About Us dropdown">
            ...
            <main>
                <div class="slider-wrapper" role="region" aria-label="Image Slider">
                    <div class="slider-container">
                        <div class="slide" id="slide1" role="tabpanel" aria-labelledby="slide1-tab">
                            ...
                            <div class="slide-content">
                                ...
                                <a href="about.html" class="slide-btn">About Us <i class="fa-solid fa-arrow-right"></i></a>
                            </div>
                        </div>
                        <div class="slide" id="slide2">
                            ...
                            <div class="slide-content">
                                ...
                                <a href="programs.html" class="slide-btn">Our Programs <i class="fa-solid fa-arrow-right"></i></a>
                            </div>
                        </div>
                        <div class="slide" id="slide3">
                            ...
                            <div class="slide-content">
                                ...
                                <a href="programs.html#mundam" class="slide-btn">See More <i class="fa-solid fa-arrow-right"></i></a>
                            </div>
                        </div>
                        <div class="slide" id="slide4">
                            ...
                            <div class="slide-content">
                                ...
                                <a href="project.html" class="slide-btn">See More <i class="fa-solid fa-arrow-right"></i></a>
                            </div>
                        </div>
                        <div class="slide" id="slide5">
                            ...
                            <div class="slide-content">
                                ...
                                <a href="programs.html#chedam" class="slide-btn">See More <i class="fa-solid fa-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="slider-nav">
                        <div class="slider-bar active" data-slide="1"></div>
                        <div class="slider-bar" data-slide="2"></div>
                        <div class="slider-bar" data-slide="3"></div>
                        <div class="slider-bar" data-slide="4"></div>
                        <div class="slider-bar" data-slide="5"></div>
                    </div>
                </div>
            </main>
            ...
            <section class="instagram-feed">
                <div class="container">
                    <h2 class="section-title">Discover Our Latest Moments</h2>
                    <p class="section-subtitle">Join our growing community of chopstick storytellers</p>
                    <div class="instagram-grid" id="instagram-grid">
                        <!-- Instagram posts will be loaded here dynamically -->
                    </div>
                    <div class="social-icons-container">
                        <a href="https://www.instagram.com/chopstickstory/" class="instagram-icon-link" target="_blank" aria-label="Visit our Instagram">
                            <div class="instagram-icon-gradient">
                                <i class="fa-brands fa-instagram"></i>
                            </div>
                        </a>
                        
                        <a href="#" class="linkedin-icon-link" aria-label="Visit our LinkedIn">
                            <div class="linkedin-icon-gradient">
                                <i class="fa-brands fa-linkedin-in"></i>
                            </div>
                        </a>
                        
                        <a href="#" class="youtube-icon-link" aria-label="Visit our YouTube channel">
                            <div class="youtube-icon-gradient">
